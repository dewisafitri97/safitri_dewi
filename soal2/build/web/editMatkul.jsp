<%-- 
    Document   : editMatkul
    Created on : Oct 21, 2018, 3:03:35 AM
    Author     : A456UR
--%>
     ...
     <ul>
        ...
        <li><a href="#">Mahasiswa</a>
			...
			<tr>
				...
				<td>
                                    <form action="MatkulController?data=matkul&proses=edit-matkul" method="post">
                                     <table style="width:100%" id='t01'>
                                          <%
                String kd_matkul = request.getParameter("kd_matkul");
                MatkulModel km = new MatkulModel();
                km.setKd_matkul(kd_matkul);;
            ...
            %>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name='nama_matkul' value="<%=data.get(0).getNama_matkul()%>"></td>
                                            <td><input type="hidden" name='kd_matkul' value="<%=data.get(0).getKd_matkul()%>"></td>
                                        </tr>
                                        <tr>
                                            <td>SKS</td>
