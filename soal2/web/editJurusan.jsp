<%-- 
    Document   : editJurusan
    Created on : Oct 21, 2018, 1:35:52 AM
    Author     : A456UR
--%>

<%@page import="java.util.List"%>
<%@page import="java.util.ArrayList"%>
<%@page import="soal2.model.JurusanModel"%>
     ...
     <ul>
        ...
        <li><a href="#">Mahasiswa</a>
			...
			<tr>
                ...
                JurusanModel km = new JurusanModel();
                km.setKd_jurusan(kd_jurusan);
            ...
            %>
                                        ...
                                        <tr>
                                            <td>Nama Jurusan</td>
                                            <td><input type="text" name='nama_jurusan' value="<%=data.get(0).getNama_jurusan()%>"></td>
                                            <td><input type="hidden" name='kd_jurusan' value="<%=data.get(0).getKd_jurusan()%>"></td>
                                        </tr>
                                        <tr>
                                            <td>Ketua Program Studi</td>
                                            <td><input type="text" name='kaprodi' value="<%=data.get(0).getKaprodi()%>"></td>
                                            <td><input type="hidden" name='kd_jurusan' value="<%=data.get(0).getKd_jurusan()%>"></td>
                                        </tr>
