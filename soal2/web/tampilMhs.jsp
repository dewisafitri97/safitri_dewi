<%-- 
    Document   : tampilMhs
    Created on : Oct 20, 2018, 9:44:21 PM
    Author     : A456UR
--%>
	...
	<body>
     ...
     <ul>
        ...
        <li><a href="#">Mahasiswa</a>
			...
			<tr>
				<td><a href="#"><button onclick="printContent('mhs')">Cetak Data Mahasiswa</button></a></td>
				<td>
                                    <div id="mhs">
		...
		<tr rowspan="2">
                ...
                <tr>
                    ...
                    <td><a href="MhsController?proses=edit-mhs&nim=<%=data.get(x).getNim()%>">Edit</a></td>
                    <td><a href="MhsController?proses=hapus-mhs&nim=<%=data.get(x).getNim()%>">Hapus</a></td>
                </tr>
                <%}%>
