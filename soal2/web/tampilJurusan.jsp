<%-- 
    Document   : tampilJurusan
    Created on : Oct 20, 2018, 9:33:43 PM
    Author     : A456UR
--%>
	...
	<body>
     ...
     <ul>
        ...
        <li><a href="#">Mahasiswa</a>
			...
			<tr>
				<td><button onclick="printContent('jurusan')">Cetak Data Jurusan</button></td>
				<td>
                                    <div id="jurusan">
		...
		<tr rowspan="2">
                ...
                <tr>
                    ...
                    <td><a href="JurusanController?proses=edit-jurusan&kd_jurusan=<%=data.get(x).getKd_jurusan()%>">Edit</a></td>
                    <td><a href="JurusanController?proses=hapus-jurusan&kd_jurusan=<%=data.get(x).getKd_jurusan()%>">Hapus</a></td>
                </tr>
                <%}%>
