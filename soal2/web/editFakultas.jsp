<%-- 
    Document   : editFakultas
    Created on : Oct 21, 2018, 12:17:11 AM
    Author     : A456UR
--%>
     ...
     <ul>
        ...
        <li><a href="#">Mahasiswa</a>
			...
			<tr>
				...
				<td>
                                    <form action="FakultasController?data=fak&proses=edit-fak" method="post">
                                     <table style="width:100%" id='t01'>
             <% String kd_fakultas = request.getParameter("kd_fakultas");
            FakultasModel ed = new FakultasModel();
            ed.setKd_fakultas(kd_fakultas);
            ...
            %>
				...
				<tr>
                                    <td>Nama Fakultas</td>
                                    <td><input type='text' name='nama_fakultas' value='<%=data.get(0).getNama_fakultas()%>'></td>
